            ...
            using (var transaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    foreach (var item in request.CoBrokers)
                    {
                        ...
                        if (coBroker == null)
                        {
                            throw new BusinessException(email + " is not a valid Trust Representative.", code);
                        }
                        ...
                        {
                            throw new BusinessException("The primary Trust Representative cannot be added as a co-broker.", code);
                        }
                    ...
                    TrustApplicationHistoryHelper.Add(
                        ...
                        application.RowID,
                        "CO_BROKER_UPDATED",
                        "Co-Broker Information Updated",
                        resolvedCoBrokers.Any()
                            ? resolvedCoBrokers.Count + " co-broker(s) saved for the Trust Application."
                            : "All co-brokers were removed from the Trust Application.",
                        userId,
                        "CO_BROKER",
                        null);
