...
namespace API_CPX.Class.Service.TrustApplication.Common
{
    public class TrustApplicationCommonService
    {
        ...
        public async Task<tbl_TrustApplication>
            GetApplicationForStepUpdateAsync(
        ...
        public async Task<tbl_TrustApplication>
            GetDraftApplicationForAgentUpdateAsync(
                Sandbox_BasedEntities db,
                string merchantId,
                long userId,
                string roleCode,
                long trustId)
        {
            ...
            {
                throw new BusinessException(
                    "Only Trust Agents are allowed to update a draft Trust Application.",
                    code);
            }
        ...
        public async Task<tbl_TrustApplication>
            GetDraftApplicationForAgentReadAsync(
                Sandbox_BasedEntities db,
                string merchantId,
                long userId,
                string roleCode,
                long trustId)
        {
            ...
            {
                throw new BusinessException(
                    "Only Trust Agents are allowed to access the Trust Application wizard.",
                    code);
            }
            ...
            {
                throw new BusinessException(
                    "You are not allowed to access this Trust Application.",
                    code);
            }
            ...
            {
                throw new BusinessException(
                    "This Trust Application has already been submitted.",
                    code);
            }
                ...
                long trustId)
        {
            ...
            if (IsAgent(roleCode))
            {
                ...
                {
                    throw new BusinessException(
                        "You are not allowed to view this Trust Application.",
                        code);
                }
            ...
            if (IsAdmin(roleCode))
            {
                ...
                {
                    throw new BusinessException(
                        "Draft Trust Applications can only be accessed by the Trust Agent.",
                        code);
                }
        ...
        public void ValidateStepAccess(tbl_TrustApplication application, int requestedStep, string roleCode)
        {
            ...
            {
                throw new BusinessException(
                    "The Trust Application wizard is only available to Trust Agents.",
                    "TRUST-APPLICATION-STEP-ACCESS");
            }
